# copied sasa's code from sasa's day 5 fuck it
# https://github.com/sasa1977/aoc/blob/master/lib/2019/201905.ex
defmodule Advent201905 do
  def run do
    IO.inspect(part1())
    IO.inspect(part2())
  end
